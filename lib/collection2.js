...
_.each([Mongo.Collection, LocalCollection], function (obj) {
  ...
  /**
   * simpleSchemas
   * @description retrieve the list of simple schemas on this collection
   * @return {Array} Schemas
   */
  obj.prototype.simpleSchemas = function () {
      if (!this._c2) return null;
      if (this._c2._simpleSchema) return null;
      return this._c2._simpleSchemas;
  }
});
